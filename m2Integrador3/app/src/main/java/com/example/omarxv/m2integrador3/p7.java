...
public class p7 extends Activity {
    ...
    private Button ubicame, ubicame2, ubicame3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ubicame=(Button)findViewById(R.id.btn);
        ubicame2=(Button)findViewById(R.id.btn2);
        ubicame3=(Button)findViewById(R.id.btn3);

        ubicame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(p7.this, Mapsp7.class);
                intent.putExtra("longitude", longitudeGPS);
                intent.putExtra("latitude", latitudeGPS);
                startActivity(intent);
            }
        });
        ubicame2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(p7.this, Mapsp7.class);
                intent.putExtra("longitude", longitudeNetwork);
                intent.putExtra("latitude", latitudeNetwork);
                startActivity(intent);
            }
        });
        ubicame3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(p7.this, Mapsp7.class);
                intent.putExtra("longitude", longitudeBest);
                intent.putExtra("latitude", latitudeBest);
                startActivity(intent);
            }
        });
        ...
        public void onLocationChanged(Location location){
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(p7.this, "Best Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        @Override
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(p7.this,"Network Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        @Override
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(p7.this,"GPS Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        @Override
